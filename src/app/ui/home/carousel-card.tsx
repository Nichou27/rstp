...
export const CarouselCard = () => {
  return (
    <Card className="w-lg mx-7">
      <CardHeader className="px-8">
        <CardTitle>
          <div className="flex w-full">
            <p className="block w-fit h-5">El taller de Pepito - Tupungato, Mendoza</p>
        ...
        <CardDescription className="w-fit">Trabajos de Pintura y albañilería</CardDescription>
      </CardHeader>
      <CardContent>
        <Carousel>
          <CarouselContent>
